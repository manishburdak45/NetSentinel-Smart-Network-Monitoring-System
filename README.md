...
graph TD
    ...
    style C fill:#8957e5,stroke:#0d1117,color:#fff
    style D fill:#d29922,stroke:#0d1117,color:#0d1117
    style E fill:#da3633,stroke:#0d1117,color:#fff
    style F fill:#da3633,stroke:#0d1117,color:#fff
    style G fill:#1f6feb,stroke:#0d1117,color:#fff
    style H fill:#f85149,stroke:#0d1117,color:#fff
```
